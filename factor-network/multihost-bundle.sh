...
# ./chaincode-reload.sh factor-buyer2 factor_scala '["init", "{\"id\": \"1\",\"mspId\":\"factor\",\"role\": \"Factor\"}", "{\"id\": \"2\",\"mspId\":\"buyer\",\"role\": \"Buyer\"}"]' /opt/chaincode/java/factor java
# ./chaincode-reload.sh common factor_scala '["init", "{\"id\": \"factor1\",\"mspId\":\"factor\",\"role\": \"Factor\",\"name\": \"Сбербанк\"}", "{\"id\": \"buyer1\",\"mspId\":\"buyer\",\"role\": \"Buyer\",\"name\": \"Мвидео\"}"]' /opt/chaincode/java/factor java
